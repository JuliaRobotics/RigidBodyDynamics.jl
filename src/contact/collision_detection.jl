function detect_contact(a, transform_a::Transform3D, b, transform_b::Transform3D)
    # fallback: switch order, negate normal
    separation, normal = detect_contact(b, transform_b, a, transform_a)
    separation, -normal
end
