facts("double pendulum") do
    ...
    inertia1 = SpatialInertia(CartesianFrame3D("body1"), I1 * @SMatrix([0. 0. 0.; 0. 1. 0.; 0. 0. 0.]), SVector(0, 0, lc1), m1) # FIXME: axis * axis'
    ...
    inertia2 = SpatialInertia(CartesianFrame3D("body2"), I2 * @SMatrix([0. 0. 0.; 0. 1. 0.; 0. 0. 0.]), SVector(0, 0, lc2), m2)
